...
var user_configuration={
	shape:"custom", //could be "circle" or "square"
	initial_size:"0.75vw", //initial size of the stars
	final_size:"1.5vw", //final size of the stars after expansion
	...
	colors:["rgba(252,238,33,1)", "rgba(252,238,33,0.5)"], //The variety of colors of the stars. Can be any CSS complient color (eg. HEX, rgba, hsl)
	frequency: 20, //how often a new wave of stars pop-out (in milliseconds. Bigger==longer)
...
var advanced_configuration={
	...
	rotation_angle: "90deg", //up to how much to rotate to
	rotation_duration: "2s", //how long the rotation will take place
...
Star.prototype.create=function(parent_element,id){
	...
	if (user_configuration.shape === 'custom') {
		var star=$('<img src=\"svg/star.svg\" ></img>');
	var star_container=$('<img id=\"starlight-star'+id+'\" src=\"svg/star.svg\" ></img>');
	}
	else {
		var star=$('<div></div>');
...
$(document).ready(function(){
	...
	$(user_configuration.target_class).each(function(index){
		...
		if (currentElement.is('#left_stars') || currentElement.is('#right_stars')) { user_configuration.frequency = 150; }
